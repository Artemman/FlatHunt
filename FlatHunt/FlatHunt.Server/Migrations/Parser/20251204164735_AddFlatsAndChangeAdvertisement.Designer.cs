...
namespace FlatHunt.Server.Migrations.Parser
{
    ...
    [Migration("20251204164735_AddFlatsAndChangeAdvertisement")]
    partial class AddFlatsAndChangeAdvertisement
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FlatHunt.Server.Auth.RefreshToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("FlatHunt.Server.Models.Advertisement", b =>
                {
                    ...
                    b.HasOne("FlatHunt.Server.Models.FlatSource", "FlatSource")
                        .WithMany("Advertisements")
                        .HasForeignKey("FlatSourceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("FlatHunt.Server.Models.User", null)
                        .WithMany()
